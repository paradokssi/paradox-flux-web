            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:border-electric-blue focus:outline-none focus:ring-2 focus:ring-electric-blue/20 transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:border-electric-blue focus:outline-none focus:ring-2 focus:ring-electric-blue/20 transition-all resize-none"
                  placeholder="Opišite svoj projekt ali potrebe..."
                />
              </div>
              
              <button
                type="submit"
                className="w-full glass-blue py-4 rounded-lg font-semibold glow-blue-hover transition-all duration-300 hover:scale-105"
              >
                Povežimo se
              </button>
            </form>
          ...
          <div className="space-y-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="glass rounded-2xl p-8 relative overflow-hidden">
              <div className="absolute inset-0 opacity-20">
                ...
                <div className="neon-line absolute bottom-1/4 left-0 right-0" style={{ animationDelay: '1s' }}></div>
                <div className="neon-line absolute top-0 bottom-0 left-1/4 w-px" style={{ animationDelay: '2s' }}></div>
                <div className="neon-line absolute top-0 bottom-0 right-1/4 w-px" style={{ animationDelay: '3s' }}></div>
              </div>
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/80">
                  Naš pisarni v Ljubljani je odprta za sestanke po predhodni najavi. 
                  Radi se vidimo osebno in razpravljamo o vaših projektih.
                </p>
              </div>
            </div>
          </div>
